      ...
      <div className="pt-2 w-fit">
        <div className="text-xs text-white/90 backdrop-blur-md bg-black/60 rounded-lg py-2 px-4 flex items-center justify-center gap-4">
          ...
          >
            ...
            <button
              type="button"
              className="w-6 h-6 rounded-md border border-white/10 bg-white/5 flex items-center justify-center cursor-pointer text-white/70 hover:text-white/90 hover:bg-white/10 transition-colors"
